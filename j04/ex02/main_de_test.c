...
/*   Updated: 2017/08/09 14:59:49 by fgiverna         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	pow = ft_iterative_power(0, 4);
	printf("0 puissance 4 : %d\n", pow);
	pow = ft_iterative_power(12, 0);
	printf("12 puissance 0 : %d\n", pow);
	pow = ft_iterative_power(2, 1);
	printf("2 puissance 1 : %d\n", pow);
	pow = ft_iterative_power(-4, 0);
	printf("-4 puissance 0 : %d\n", pow);
	pow = ft_iterative_power(10, 4);
	printf("10 puissance 4 : %d\n", pow);
	pow = ft_iterative_power(5, 2);
	printf("5 puissance 2 : %d\n", pow);
	pow = ft_iterative_power(0, 0);
	printf("0 puissance 0 : %d\n", pow);
	pow = ft_iterative_power(-5, 3);
