...
/*   Updated: 2017/08/09 14:47:34 by fgiverna         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	fact = ft_iterative_factorial(0);
	printf("Factorielle 0 : %d\n", fact);
	fact = ft_iterative_factorial(1);
	printf("Factorielle 1 : %d\n", fact);
	fact = ft_iterative_factorial(2);
	...
	fact = ft_iterative_factorial(10);
	printf("Factorielle 10 : %d\n", fact);
	fact = ft_iterative_factorial(11);
	printf("Factorielle 11 : %d\n", fact);
	fact = ft_iterative_factorial(12);
	printf("Factorielle 12 : %d\n", fact);
	fact = ft_iterative_factorial(13);
